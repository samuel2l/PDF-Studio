...
export function CsvCell({ value }: CsvCellProps) {
    ...
    <>
      <div className="group/cell flex max-w-[280px] items-center gap-0.5">
        <button
          ...
          className="min-w-0 flex-1 truncate text-left hover:text-brand-700"
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
              <p className="text-sm font-semibold text-slate-800">Cell value</p>
              <button
                type="button"
                onClick={() => setOpen(false)}
